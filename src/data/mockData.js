// =============================================
// MOCK DATABASE — mirrors Google Sheets schema
// =============================================
...
export const mockOrders = [
  {
    ...
    paymentMethod: 'gpay', paymentStatus: 'verified', paymentScreenshot: null,
    status: 'shipped', trackingId: 'TRK123456789', couponCode: null,
  ...
  },
  {
    ...
    paymentMethod: 'cod', paymentStatus: 'pending', paymentScreenshot: null,
    status: 'processing', trackingId: null, couponCode: 'WELCOME10',
  ...
  },
  {
    ...
    paymentMethod: 'gpay', paymentStatus: 'pending', paymentScreenshot: null,
    status: 'pending', trackingId: null, couponCode: null,
    createdAt: '2024-06-01', updatedAt: '2024-06-01'
  },
];

export const mockPayments = [
  { id: 'pay1', orderId: 'ord1', method: 'gpay', amount: 3896, screenshot: null, status: 'verified', verifiedAt: '2024-05-25' },
  { id: 'pay2', orderId: 'ord3', method: 'gpay', amount: 998, screenshot: null, status: 'pending', verifiedAt: null },
];
